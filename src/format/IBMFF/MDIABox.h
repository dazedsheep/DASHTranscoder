...
class MDIABox : public IBox
{
private:
    /* extend this list for further boxes */
    mdia_t box;
    bool container;
    ...
    Context *ctx;
public:
    MDIABox(Context *ctx, IBuffer *buffer, box_t *header);     // will try to parse the box directly from the given chunk
    virtual ~MDIABox();
    bool isContainer();
    uint32_t getBoxType();
